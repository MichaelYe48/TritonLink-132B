                    ...
                    try {
                        ...
                        if (action != null && action.equals("insert")) {
                            ...
                            PreparedStatement checkStmt = connection.prepareStatement(
                                "SELECT COUNT(*) FROM Precandidacy WHERE SSN = ?");
                            ...
                            if (count == 0) { // If record doesn't exist, then insert
                                PreparedStatement pstmt = connection.prepareStatement(
                                    "INSERT INTO Precandidacy (SSN) VALUES (?)");
                        ...
                        if (action != null && action.equals("update")) {
                            PreparedStatement pstatement = connection.prepareStatement(
                                "UPDATE Precandidacy SET SSN = ? WHERE SSN = ?");
                        ...
                        if (action != null && action.equals("delete")) {
                            PreparedStatement pstmt1 = connection.prepareStatement(
                                "DELETE FROM Precandidacy WHERE SSN = ?");
                        ...
                        rs = statement.executeQuery("SELECT * FROM Precandidacy");
                    %>
                <table>
                    <tr>
                        <th>SSN</th>
