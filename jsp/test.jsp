            ...
            <td>
                ...
                <table>
                    ...
                    while (rs.next()) {
                        ...
                        String numEnrolled = "SELECT COUNT(*) AS num " +
                                                "FROM Enrolled_In e " +
                                                "WHERE e.Section_id = ?";
                        // Create a scrollable ResultSet
                        PreparedStatement pstmtquery = connection.prepareStatement(numEnrolled);
                        pstmtquery.setInt(1, rs.getInt("Section_id"));
                    ...
                    <tr>
                        <form action="sections.jsp" method="get">
                            ...
                            <th><input value="<%= rsQuery.getInt("num") %>" name="Number_enrolled"></th>
