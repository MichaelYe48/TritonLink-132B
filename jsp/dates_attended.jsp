...
try {
    ...
    if (action != null) {
        if (action.equals("insert")) {
            ...
            PreparedStatement pstmt = connection.prepareStatement(
                "UPDATE Dates_Attended SET Start_Quarter = ?, End_Quarter = ?, Start_Year = ?, End_Year = ? WHERE SSN = ?");
            ...
            PreparedStatement pstmt = connection.prepareStatement(
                "DELETE FROM Dates_Attended WHERE SSN = ?");
            pstmt.setString(1, request.getParameter("SSN"));
            pstmt.executeUpdate();
            pstmt.close();
        }
...
<table>
    ...
    <tr>
        <form action="dates_attended.jsp" method="get">
